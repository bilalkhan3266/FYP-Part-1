...
export default function MessagePage() {
  ...
  const displayName = user?.full_name || "Fee Department Staff";
  const displaySap = user?.sap || "N/A";
  const displayDept = user?.department || "Fee Department";
    ...
    <div className="student-dashboard-page">
      <aside className="sd-sidebar">
        ...
        <nav className="sd-nav">
          ...
          <button
            className="sd-nav-btn"
            onClick={() => navigate("/fee-department-view-student-request")}
          >
            📋 View Student Request
          </button>
          <button
            className="sd-nav-btn"
            onClick={() => navigate("/fee-department-approved-requests")}
          >
            ✅ Approved Requests
          </button>
          <button
            className="sd-nav-btn active"
            onClick={() => navigate("/fee-department-messages")}
          >
          ...
          <button
            className="sd-nav-btn"
            onClick={() => navigate("/fee-department-edit-profile")}
          >
            📝 Edit Profile
          </button>
