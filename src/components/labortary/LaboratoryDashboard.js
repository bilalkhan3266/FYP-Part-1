...
export default function LaboratoryDashboard() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      if (activeTab === "pending") {
        endpoint = "/api/laboratory/pending-requests";
      } else if (activeTab === "approved") {
        endpoint = "/api/laboratory/approved-requests";
      } else if (activeTab === "rejected") {
        endpoint = "/api/laboratory/rejected-requests";
      }
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        apiUrl + `/api/laboratory/requests/${modalRequestId}/approve`,
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        apiUrl + `/api/laboratory/requests/${modalRequestId}/reject`,
        { remarks: remarks.trim() },
        {
          headers: {
            Authorization: "Bearer " + token,
    ...
    <div className="student-dashboard-page">
      ...
      <main className="sd-main">
        <header className="sd-header">
          <h1>🧪 Laboratory Clearance Management</h1>
