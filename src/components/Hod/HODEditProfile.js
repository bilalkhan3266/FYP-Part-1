...
export default function HODEditProfile() {
    ...
    <div className="edit-profile-page">
      ...
      <aside className="sd-sidebar">
        <div className="sd-profile">
          ...
          <div>
            <h3 className="sd-name">{user?.full_name || "HOD"}</h3>
            <p className="sd-small">
              {user?.sap || "N/A"} • {user?.department || "Administration"}
            </p>
        ...
        <nav className="sd-nav">
          <button className="sd-nav-btn" onClick={() => navigate("/hod-dashboard")}>
            🏠 Dashboard
          </button>
          <button className="sd-nav-btn active">📝 Edit Profile</button>
          <button className="sd-nav-btn" onClick={() => navigate("/hod-messages")}>
            💬 Messages
          </button>
          <button className="sd-nav-btn" onClick={() => navigate("/hod-dashboard")}>
            🚪 Back
