...
import { 
  ...
  DollarSign, AlertCircle, CheckCircle, Lock, Mail, Save, Camera, Menu
} from "lucide-react";
...
export default function FeeEditProfile() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans text-gray-800 overflow-hidden">
      ...
      {/* ── SIDEBAR ── */}
      <aside className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 w-[280px] fixed lg:relative h-screen lg:h-auto transition-transform duration-300 z-40 lg:z-auto flex flex-col bg-gradient-to-b from-[#5a2e0f] via-[#8b4513] to-[#654321] text-white py-6 px-4 shadow-xl overflow-y-auto shrink-0`}>
        {/* Logo & Title */}
        ...
        <nav className="flex flex-col gap-1 flex-1">
          ...
          <button
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium bg-gradient-to-r from-orange-500 to-amber-600 text-white shadow-lg shadow-orange-500/20"
          >
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="px-6 py-6">
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 placeholder:text-gray-400"
                />
              </div>
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center gap-3">
              <button
                type="submit"
                disabled={loading}
                className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-orange-600 to-amber-600 text-white text-sm font-semibold shadow-lg shadow-orange-600/20 hover:shadow-xl active:scale-[0.98] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
              >
