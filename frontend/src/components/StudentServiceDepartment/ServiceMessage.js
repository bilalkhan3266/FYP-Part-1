...
import { LayoutDashboard, MessageSquare, UserPen, LogOut, Send, Inbox, AlertTriangle, CheckCircle, History, Megaphone, Reply, X, Paperclip, ThumbsDown, AlertCircle, Search, Clock, Star, Share2, Users } from "lucide-react";
...
export default function ServiceMessage() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans text-gray-800 overflow-hidden">
      <aside className="w-[280px] flex flex-col bg-gradient-to-b from-emerald-900 via-emerald-800 to-green-900 text-white py-6 px-4 shadow-2xl overflow-y-auto shrink-0">
