...
async function checkClearanceRequests() {
  try {
    console.log('🔗 Connecting to MongoDB...\n');
    await mongoose.connect(mongoose_url);
    console.log('✅ Connected\n');

    console.log('📊 CLEARANCE REQUEST STATUS DISTRIBUTION:\n');
    
    const statuses = await ClearanceRequest.aggregate([
    ...
    console.log('\n📍 BY DEPARTMENT:\n');
    const departments = await ClearanceRequest.aggregate([
    ...
    console.log('\n📈 OVERALL:\n');
    const overall = await ClearanceRequest.aggregate([
