...
// GET — get auto-clearance status and statistics
router.get("/status", getAutoClearanceStatus);

// POST — toggle auto-clearance on/off
router.post("/toggle", toggleAutoClearance);
